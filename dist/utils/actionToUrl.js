...
exports.formatHash = exports.formatQuery = exports.defaultToPath = exports.default = void 0;

var _pathToRegexp = _interopRequireDefault(require("path-to-regexp"));

var _applyDefaults = require("./applyDefaults");
...
var _default = function _default(action, api, prevRoute) {
  ...
  try {
    ...
    var pathname = (0, _index.compileUrl)(path, p, q, h, route, opts) || '/';
    var url = bn + pathname;
    return {
      url: url,
      state: s
...
var formatParams = function formatParams(params, route, opts) {
  params = (0, _applyDefaults.applyObjectDefault)(route.defaultParams || opts.defaultParams)(params, route, opts);

  if (params) {
    var keys = [];
    (0, _pathToRegexp.default)(typeof route === 'string' ? route : route.path, keys);
    var newParams = {};
...
exports.defaultToPath = defaultToPath;

var formatQuery = function formatQuery(query, route, opts) {
  query = (0, _applyDefaults.applyObjectDefault)(route.defaultQuery || opts.defaultQuery)(query, route, opts);
...
var formatHash = function formatHash(hash, route, opts) {
  hash = (0, _applyDefaults.applyStringDefault)(route.defaultHash || opts.defaultHash)(hash, route, opts);
...
var formatState = function formatState(state, route, opts) {
  return (0, _applyDefaults.applyObjectDefault)(route.defaultState || opts.defaultState)(state, route, opts);
