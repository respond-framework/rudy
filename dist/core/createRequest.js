...
var _default = function _default(action, api, next) {
  return new Request(action, api, next);
};

exports.default = _default;

var Request = function Request(_action, api, next) {
  var _this = this;
  ...
  _defineProperty(this, "populateAction", function (act) {
    var type;
    var action = (0, _utils.isAction)(act) ? act : typeof act === 'string' && (type = _this.isActionType(act)) ? {
      type: type
    } : {
      payload: act
    };
