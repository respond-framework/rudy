...
var _default = function _default(req) {
  ...
  var _ref = !req.commitHistory ? (0, _utils.actionToUrl)(action, req, prevRoute) : {
  ...
  var redirect = (0, _utils.isRedirect)(action);
  ...
  if (!tmp.committed && tmp.from && (n = (0, _index.findNeighboringN)(tmp.from, curr))) {
    method = 'replacePop';
    info = (0, _index.replacePopAction)(n, url, curr, tmp);
  }
  ...
  if (!req.commitHistory || method === 'replacePop') {
    var _history$method = history[method](url, state, false, info),
        ...
        _action = _objectWithoutProperties(_history$method, ["commit"]); // get returned the same action as functions passed to `history.listen`
  ...
  return (0, _utils.nestAction)(req.action, prev, from, status, tmp);
};

exports.default = _default;
//# sourceMappingURL=formatAction.js.map