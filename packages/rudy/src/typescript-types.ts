...
export type LocationEntry<Action extends FluxStandardRoutingAction> = Required<Action> & {
  location: {
    key: string,
    scene: string,
    url: string,
...
export type DispatchedLocation<Action extends FluxStandardRoutingAction> = Required<Action> & {
 ...
 */
export type DispatchedAction<Action extends FluxStandardRoutingAction> = Required<Action> & {
 ...
 */
export type Location<Action extends FluxStandardRoutingAction> = DispatchedAction<Action> & DispatchedLocation<Action>
